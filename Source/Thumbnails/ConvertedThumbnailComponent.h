...
public:
    ...
    {
        openButton.setBounds (10, 510, 100, 20);
        playButton.setBounds (10, 540, 100, 20);
        stopButton.setBounds (10, 570, 100, 20);

        juce::Rectangle<int> thumbnailBounds (10, 100, 620, 620);
